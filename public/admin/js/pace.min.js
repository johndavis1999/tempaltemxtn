(function() {
    var t, e, n, r, s, o, i, a, u, c, l, p, h, f, d, g, m, y, v, w, b, k, S, q, L, x, T, R, P, E, M, j, A, N, O, _, F, C, U, W, X, D, H, I, z, G, B, J, K = [].slice, Q = {}.hasOwnProperty, V = function(t, e) {
        function n() {
            this.constructor = t
        }
        for (var r in e)
    ...
    k = function() {
        ...
        for (e = arguments[0],
        o = 0,
        i = (r = 2 <= arguments.length ? K.call(arguments, 1) : []).length; i > o; o++)
            if (n = r[o])
                for (t in n)
                    Q.call(n, t) && (s = n[t],
    ...
    H = 0,
    z = (B = ["ajax", "document", "eventLag", "elements"]).length; z > H; H++)
        !0 === E[F = B[H]] && (E[F] = b[F]);
    u = function(t) {
        function e() {
    ...
    e = function() {
        ...
        return t.prototype.getElement = function() {
            var t;
            if (null == this.el) {
                if (!(t = document.querySelector(E.target)))
                    throw new u;
        ...
        t.prototype.render = function() {
            var t, e, n, r, s, o, i;
            if (null == document.querySelector(E.target))
                return !1;
            for (t = this.getElement(),
            r = "translate3d(" + this.progress + "%, 0, 0)",
            s = 0,
            o = (i = ["webkitTransform", "msTransform", "transform"]).length; o > s; s++)
                e = i[s],
    ...
    a = function() {
        ...
        return t.prototype.trigger = function(t, e) {
            ...
            if (null != this.bindings[t]) {
                for (i = [],
                r = 0,
                s = (o = this.bindings[t]).length; s > r; r++)
                    n = o[r],
    ...
    S = function(t, e) {
        ...
        e.prototype)
            try {
                r = e.prototype[n],
                s.push(null == t[n] && "function" != typeof r ? t[n] = r : void 0)
            } catch (t) {
                t
            }
        return s
    ...
    _ = function(t) {
        ...
        "track" === T[0])
            return "force";
        if (!T.length && E.ajax) {
            if ("socket" === t && E.ajax.trackWebSockets)
                return !0;
            if (e = t.toUpperCase(),
            Y.call(E.ajax.trackMethods, e) >= 0)
                return !0
        }
        return !1
    }
    ...
    O = function(t) {
        var e, n, r, s;
        for (n = 0,
        r = (s = E.ajax.ignoreURLs).length; r > n; n++)
    ...
    (L = function() {
        ...
        s = e.request,
        i = e.url,
        O(i) ? void 0 : c.running || !1 === E.restartOnRequestAfter && "force" !== _(o) ? void 0 : (r = arguments,
    ...
    t = function() {
        ...
        return t.prototype.watch = function(t) {
            ...
            e = t.request,
            s = t.url,
            O(s) ? void 0 : (n = "socket" === r ? new f(e) : new d(e),
    ...
    d = function() {
        return function(t) {
            ...
            null != window.ProgressEvent)
                ...
                n = 0,
                r = (o = ["load", "abort", "timeout", "error"]).length; r > n; n++)
                    e = o[n],
    ...
    o = function() {
        return function() {
            ...
            e = setInterval(function() {
                ...
                t = m(s),
                ++r >= E.eventLag.minSamples && t < E.eventLag.lagThreshold ? (o.progress = 100,
                clearInterval(e)) : o.progress = 3 / (t + 3) * 100
            }, 50)
        }
    }(),
    h = function() {
        ...
        return t.prototype.tick = function(t, e) {
            var n;
            return null == e && (e = j(this.source, "progress")),
            e >= 100 && (this.done = !0),
    ...
    null != window.history.replaceState && (J = window.history.replaceState,
    ...
    (R = function() {
        ...
        for (c.sources = C = [],
        n = 0,
        s = (i = ["ajax", "elements", "document", "eventLag"]).length; s > n; n++)
            !1 !== E[t = i[n]] && C.push(new p[t](E[t]));
        for (r = 0,
        o = (u = null != (a = E.extraSources) ? a : []).length; o > r; r++)
            F = u[r],
            C.push(new F(E));
    ...
    c.go = function() {
        ...
        g = A(function(e, n) {
            ...
            w = C.length; w > g; u = ++g)
                ...
                f = null != N[u] ? N[u] : N[u] = [],
                l = m = 0,
                b = (a = null != (k = F.elements) ? k : [F]).length; b > m; l = ++m)
                    i = a[l],
                    o &= (p = null != f[l] ? f[l] : f[l] = new h(i)).done,
                    p.done || (s++,
                    d += p.tick(e));
            return r = d / s,
            y.update(U.tick(e, r)),
    ...
    "function" == typeof define && define.amd ? define(function() {
        return c
    }) : "object" == typeof exports ? module.exports = c : E.startOnPageLoad && c.start()
}
).call(this);
